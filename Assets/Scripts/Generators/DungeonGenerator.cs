 ...
 */
public class DungeonGenerator : IMZDungeonGenerator
{
    protected long seed;
     ...
     */
    public DungeonGenerator(int seed, IMZDungeonConstraints constraints, int nOfRooms)
    {
                ...
                while (keepTrying)
                {
                    ...
                    catch (OutOfRoomsException e)
                    {
                        ...
                        if (roomsPerLock == 0)
                        {
                            ...
                            {
                                Debug.Log("Failed too many times, restart.");
